...
Now you can use the <Link href="/solid/api/insert/">`insert`</Link>, <Link href="/solid/api/move/">`move`</Link>, <Link href="/solid/api/remove/">`remove`</Link>, <Link href="/solid/api/replace/">`replace`</Link>, and <Link href="/solid/api/swap/">`swap`</Link> methods to make changes to the field array. These methods automatically take care of rearranging all the fields.
