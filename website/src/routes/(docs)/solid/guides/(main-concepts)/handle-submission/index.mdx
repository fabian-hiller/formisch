...
To process the values on submission, you need to pass a function to the `onSubmit` property of the <Link href="/solid/api/Form/">`Form`</Link> component. The first parameter passed to the function contains the validated form values.
...
Congratulations! You've learned the core concepts of building forms with Formisch. To learn more about advanced features, check out the <Link href="/solid/guides/form-methods/">form methods</Link> guide to discover how to programmatically control your forms.
