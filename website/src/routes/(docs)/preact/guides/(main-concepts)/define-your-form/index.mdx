...
Formisch is a schema-first form library built on top of [Valibot](https://valibot.dev/). When you create a form with <Link href="/preact/api/useForm/">`useForm`</Link>, TypeScript types are automatically inferred from your schema, giving you full autocompletion and type safety throughout your form without needing to write any manual type definitions.
...
Now that you understand how to define your form schema, continue to the <Link href="/preact/guides/create-your-form/">create your form</Link> guide to learn how to initialize your form with <Link href="/preact/api/useForm/">`useForm`</Link>.
