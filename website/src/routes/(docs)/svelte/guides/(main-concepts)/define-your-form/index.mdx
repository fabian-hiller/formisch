...
Now that you understand how to define your form schema, continue to the <Link href="/svelte/guides/create-your-form/">create your form</Link> guide to learn how to initialize your form with <Link href="/svelte/api/createForm/">`createForm`</Link>.
