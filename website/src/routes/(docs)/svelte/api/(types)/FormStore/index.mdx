...
source: /frameworks/svelte/src/types/form.ts
contributors:
  - fabian-hiller
---
...
Form store interface that provides reactive access to the state of a form created with <Link href="../createForm/">`createForm`</Link>.
