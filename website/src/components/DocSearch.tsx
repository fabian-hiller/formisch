      ...
      if (open.value) {
        ...
        if (item) {
          ...
          trackEvent('select_search_item', {
            input: input.value,
            // eslint-disable-next-line qwik/scope-use-task
            path: item.path,
          });
        }
        ...
        <>
          ...
          >
            ...
            <footer class="flex h-12 shrink-0 items-center justify-end px-4 text-xs md:h-14 md:text-sm lg:h-[72px] lg:px-6">
              ...
              <TextLink
                class="ml-2 md:ml-3"
                href="https://www.algolia.com/ref/docsearch/?utm_source=formisch.dev&utm_medium=referral&utm_content=powered_by&utm_campaign=docsearch"
                target="_blank"
              >
