...
export default tseslint.config(
  ...
  pluginSecurity.configs.recommended,
  {
    ...
    rules: {
      ...
      // Import
      'import/extensions': ['error', 'ignorePackages'], // Require file extensions
      ...
      // Security
      'security/detect-object-injection': 'off', // Disable this rule, because it is not applicable in SolidJS context.
    },
  }
);
